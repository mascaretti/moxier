...
Welcome to your first lab class of R!

Before beginning, we will download and set up both R and RStudio.
...
### RStudio in a glimpse
[RStudio](https://rstudio.com/) is an [IDE](https://en.wikipedia.org/wiki/Integrated_development_environment) specifically designed for R (we'll come back to it in a minute).

It comprises a set of tools to develop and deploy project in statistics and data analysis (this notebook was designed with RStudio!)
...
RStudio is an Integrated Development Environment for R. What does that mean? Well, if you think of R as a language, which it is, you can think of RStudio as a program that helps you write and work in the language. It contains a set of tool to organise, debug, write your code and communicate the results.
RStudio makes programming in R much easier and I suggest that you use it!
